	...
	<footer>
		<p> Todos los derechos reservados © Carolina Cuevas Andreu</p>		
	</footer>
	...
	<script type="text/javascript" src="<?php echo get_template_directory_uri() ?>/assets/js/jcarousel.js"></script>
